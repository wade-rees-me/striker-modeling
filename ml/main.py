...
if __name__ == "__main__":
    ...
    if args.chart_flag:
        ...
        chart.build_charts_neural(constant.NEURAL, constant.SINGLE_DECK)
        #chart.build_charts_neural(constant.NEURAL, constant.DOUBLE_DECK)
        #chart.build_charts_neural(constant.NEURAL, constant.SIX_SHOE)
