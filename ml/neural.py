...
#    data_df = normalize_column(data_df, 'up', min_value=constant.MINIMUM_CARD, max_value=constant.MAXIMUM_CARD)
#    data_df = data_df.values.reshape(1, -1)
#    y = model.predict(data_df)
#    return reverse_normalize_nested_values(y, constant.MINIMUM_WIN, constant.MAXIMUM_WIN)[0][0]
